...
- [Import decretos: WIP + aprendizados](decretos-import-aprendizados.md) — branch feat/creditos-decretos-reais; semântica da API validada, dedup, S/N; BLOQUEIO: ordem real = cadeia antes→saldo por dotação (não nº decreto); NÃO rodar --apply antes
