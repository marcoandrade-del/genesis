...
export const fabricantesConversor: Record<string, FabricanteInfo> = {
  ...
  betha: {
    ...
    campos: [
      {
        chave: 'portalHash',
        label: 'Hash do portal',
        tipo: 'texto',
        escopo: 'municipio',
        ajuda: 'Identificador do portal na URL do município — o trecho entre "#/" e "/…" em transparencia.betha.cloud/#/<hash>/dados-abertos. A leitura é por API (token anônimo automático), sem upload.',
      },
      {
        ...
        tipo: 'texto',
        escopo: 'municipio',
        ajuda: 'Id do dataset "Receitas Orçamentárias" no portal (compartilhado pelas entidades). Ex. Criciúma: 34858.',
      },
      {
        ...
        tipo: 'texto',
        escopo: 'municipio',
        ajuda: 'Id do dataset "Despesas por Classificação Orçamentária" (execução por empenho, com dimensões). Ex. Criciúma: 174485.',
      },
      {
        chave: 'entidadeBetha',
        label: 'Código da entidade no portal',
        tipo: 'texto',
        escopo: 'entidade',
        ajuda: 'Código da entidade no portal (o 2º campo do id dos registros, ex. 184 = Prefeitura). Filtra os dados desta entidade; vazio = todas.',
      },
    ],
  },
}
