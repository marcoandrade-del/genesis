...
export async function adminEntidadesRoutes(app: FastifyInstance) {
  ...
  app.post<{ Body: { municipioId: string; nome: string; tipo: string; ano: string; cnpj: string } }>(
    '/',
    async (req, reply) => {
  ...
  // ── UPDATE ──────────────────────────────────────────────────────────────────
  app.put<{ Params: { id: string }; Body: { nome: string; tipo: string; cnpj: string; ativo?: string } }>(
    '/:id',
    async (req, reply) => {
